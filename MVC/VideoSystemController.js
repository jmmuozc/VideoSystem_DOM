...
class videoSystemController {
    ...
    #loadDefaultObjects() {
        ...
        let person3 = this.#videoSystemModel.personFactory("Emilio", "31186215D", "Martínez", "30/11/1944");
        ...
        let person4 = this.#videoSystemModel.personFactory("Ben", "84718220C", "Stiller", "30/11/1965");
        this.#videoSystemModel.addActor(person4);
        let person5 = this.#videoSystemModel.personFactory("Owen", "36685822V", "Wilson", "18/11/1968");
        ...
        let person7 = this.#videoSystemModel.personFactory("Stana", "06859582Q", "Katic", "26/4/1978");
        ...
        let person10 = this.#videoSystemModel.personFactory("Jonathan", "18041889E", "Banks", "31/1/1947");
        this.#videoSystemModel.addActor(person10);
        let person11 = this.#videoSystemModel.personFactory("Terry", "39726325N", "Mcdonough", "23/12/1966");
        ...
        let person12 = this.#videoSystemModel.personFactory("Lyn", "41629302S", "May", "12/12/1952");
        this.#videoSystemModel.addActor(person12);
        let person13 = this.#videoSystemModel.personFactory("José María", "00375747L", "Torre", "04/11/1977");
        ...
        let person16 = this.#videoSystemModel.personFactory("Ana", "30028098B", "Dearmas", "30/4/1988");
        ...
        let person19 = this.#videoSystemModel.personFactory("Jenna", "46401836A", "Ortega", "27/9/2002");
        ...
        let person22 = this.#videoSystemModel.personFactory("Marianly", "26545283V", "Tejada", "04/7/1992");
        this.#videoSystemModel.addActor(person22);
        let person23 = this.#videoSystemModel.personFactory("Jennifer", "95305815W", "Morrison", "12/4/1979");
        ...
        let person24 = this.#videoSystemModel.personFactory("Brendan", "73509482X", "Fraser", "02/12/1968");
        this.#videoSystemModel.addActor(person24);
        let person25 = this.#videoSystemModel.personFactory("Josh", "92318914L", "Hutcherson", "12/10/1992");
        this.#videoSystemModel.addActor(person25);
        let person26 = this.#videoSystemModel.personFactory("Henry", "58451547Z", "Levin", "05/6/1909");
        ...
        let person27 = this.#videoSystemModel.personFactory("Florence", "06927439T", "Stanley", "01/7/1924");
        this.#videoSystemModel.addActor(person27);
        let person28 = this.#videoSystemModel.personFactory("John", "04518192A", "Mahoney", "20/6/1940");
        ...
        let person31 = this.#videoSystemModel.personFactory("Henry", "49924909M", "Cavill", "05/5/1983");
        ...
        let person34 = this.#videoSystemModel.personFactory("Justin", "11442737F", "Roiland", "21/2/1980");
        ...
        this.#videoSystemModel.assignActor(production1,person1,person2);
        this.#videoSystemModel.assignDirector(production1,person3);
        this.#videoSystemModel.assignActor(production2,person4,person5);
        this.#videoSystemModel.assignDirector(production2,person4);
        this.#videoSystemModel.assignActor(production3,person6,person7);
        this.#videoSystemModel.assignDirector(production3,person8);
        this.#videoSystemModel.assignActor(production4,person9,person10);
        this.#videoSystemModel.assignDirector(production4,person11);
        
        this.#videoSystemModel.assignCategory(category2,production5,production6,production7,production8);
        this.#videoSystemModel.assignActor(production5,person12,person13);
        this.#videoSystemModel.assignDirector(production5,person14);
        this.#videoSystemModel.assignActor(production6,person15,person16);
        this.#videoSystemModel.assignDirector(production6,person17);
        this.#videoSystemModel.assignActor(production7,person18,person19);
        this.#videoSystemModel.assignDirector(production7,person20);
        this.#videoSystemModel.assignActor(production8,person21,person22);
        this.#videoSystemModel.assignDirector(production8,person23);

        this.#videoSystemModel.assignCategory(category3,production9,production10,production11,production12);
        this.#videoSystemModel.assignActor(production9,person24,person25);
        this.#videoSystemModel.assignDirector(production9,person26);
        this.#videoSystemModel.assignActor(production10,person27,person28);
        this.#videoSystemModel.assignDirector(production10,person29);
        this.#videoSystemModel.assignActor(production11,person30,person31);
        this.#videoSystemModel.assignDirector(production11,person32);
        this.#videoSystemModel.assignActor(production12,person33,person34);
        this.#videoSystemModel.assignDirector(production12,person35);
    }
