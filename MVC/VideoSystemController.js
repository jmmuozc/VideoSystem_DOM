...
class videoSystemController {
    ...
    /**
     * Metodo que introduce los objetos por defecto
     */
    #loadDefaultObjects() {
    ...
    constructor(videoSystemModel, videoSystemView) {
        ...
        // Lo invocamos una vez se han cargado los eventos de la carga inicial
        this.onInit();
    ...
    /**
     * Función que inicia las funciones introducidas en la carga de la página
     */
    onLoad = () => {
    ...
    /**
     * Función que inicia los funciones introducidas al iniciar la página
     */
    onInit = () => {
        // Realiza los metodos que rellenan la página
        ...
        // Vincula los listener con sus respectivos eventos
    ...
    /**
     * Función que le añade el evento a bindInit
     */
    handleInit = () => {
        this.onInit();
    }
    ...
    /**
     * Funcion que añade el evento a bindCategory y llama al evento de ProductionCard
     * @param {String} name 
     */
    handleCategory = (name) => {
    ...
    /**
     * Funcion que añade el evento a bindSeries y llama al evento de ProductionCard
     */
    handleSeries = () => {
        this.onClickSeries();
        this.#videoSystemView.bindProductionCard(this.HandleProduction);
    ...
    /**
     * Funcion que añade el evento a bindMovies y llama al evento de ProductionCard
     */
    handleMovies = () => {
        this.onClickMovies();
        this.#videoSystemView.bindProductionCard(this.HandleProduction);
    ...
    /**
     * Funcion que añade el evento a bindActors y llama al evento de ActorCard
     */
    handleActors = () => {
        this.onClickActors();
    ...
    /**
     * Funcion que añade el evento a bindDirectors y llama al evento de DirectorCard
     */
    handleDirectors = () => {
    ...
    /**
     * Funcion que añade el evento a BindActorCard y llama al evento de ProductionCard
    ...
    /**
     * Funcion que añade el evento a bindDirectorCard y llama al evento de ProductionCard
     * @param {String} picture 
     */
    ...
    /**
     * Funcion que añade el evento a bindCategory y llama al evento de ActorCard y DirectorCard
     * @param {String} title 
     */
    ...
    /**
     * Busca las producciones del nombre de una categoria y usa el nombre introducido
     * @param {String} name 
     */
    ...
    /**
     * Devuelve todas las series y una string que indica qué son
     */
    onClickSeries = () => {
    ...
    /**
     * Devuelve todas las Peliculas y una string que indica qué son
     */
    onClickMovies = () => {
    ...
    /**
     * Devuelve todos los actores y una string que indica qué son
     */
    onClickActors = () => {
    ...
    /**
     * Devuelve todos los directores y una string que indica qué son
     */
    onClickDirectors = () => {
    ...
    /**
     * Devuelve el actor según su imagen y la lista de producciones en las que participa
     * @param {String} picture 
     */
    ...
    /**
     * Devuelve el director según su imagen y la lista de producciones en las que participa
     * @param {String} picture 
     */
    ...
    /**
     * Devuelve la producción según su título y la lista de actores y directores que participan
     * @param {String} title 
     */
